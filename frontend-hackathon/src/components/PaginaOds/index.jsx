    ...
    return (
        <div>
            ...
            <section class="odsSection" id="ods1">
                ...
                <h1 class="tituloPgOds">ODS 1 - Erradicação da pobreza</h1>
            ...
            <section class="odsSection" id="ods2">
                <h1 class="tituloPgOds">ODS 2 - Fome zero e agricultura sustentável</h1>
                <p class="parOds">
            ...
            <section class="odsSection" id="ods3">
                <h1 class="tituloPgOds">ODS 3 - Saúde e Bem-Estar</h1>
                <p class="parOds">
            ...
            <section class="odsSection" id="ods4">
                <h1 class="tituloPgOds">ODS 4 - Educação de Qualidade</h1>
                <p class="parOds">
            ...
            <section class="odsSection" id="ods5">
                <h1 class="tituloPgOds">ODS 5 - Igualdade de Gênero</h1>
                <p class="parOds">
            ...
            <section class="odsSection" id="ods6">
                <h1 class="tituloPgOds">ODS 6 - Água Potável e Saneamento</h1>
                <p class="parOds">
            ...
            <section class="odsSection" id="ods7">
                <h1 class="tituloPgOds">ODS 7 - Energia Acessível e Limpa</h1>
                <p class="parOds">
            ...
            <section class="odsSection" id="ods8">
                <h1 class="tituloPgOds">ODS 8 - Trabalho Decente e Crescimento Econômico</h1>
                <p class="parOds">
            ...
            <section class="odsSection" id="ods9">
                <h1 class="tituloPgOds">ODS 9 - Indústria, Inovação e Infraestrutura</h1>
                <p class="parOds">
            ...
            <section class="odsSection" id="ods10">
                <h1 class="tituloPgOds">ODS 10 - Redução das Desigualdades</h1>
                <p class="parOds">
            ...
            <section class="odsSection" id="ods11">
                <h1 class="tituloPgOds">ODS 11 - Cidades e Comunidades Sustentáveis</h1>
                <p class="parOds">
            ...
            <section class="odsSection" id="ods12">
                <h1 class="tituloPgOds">ODS 12 - Consumo e Produção Responsáveis</h1>
                <p class="parOds">
            ...
            <section class="odsSection" id="ods13">
                <h1 class="tituloPgOds">ODS 13 - Ação Contra a Mudança Global do Clima</h1>
                <p class="parOds">
            ...
            <section class="odsSection" id="ods14">
                <h1 class="tituloPgOds">ODS 14 - Vida na Água</h1>
                <p class="parOds">
            ...
            <section class="odsSection" id="ods15">
                <h1 class="tituloPgOds">ODS 15 - Vida Terrestre</h1>
                <p class="parOds">
            ...
            <section class="odsSection" id="ods16">
                <h1 class="tituloPgOds">ODS 16 - Paz, Justiça e Instituições Eficazes</h1>
                <p class="parOds">
            ...
            <section class="odsSection" id="ods17">
                <h1 class="tituloPgOds">ODS 17 - Parcerias e Meios de Implementação</h1>
                <p class="parOds">
